...
package com.osk2090.mybatis.ex02.e;
...
public class Exam0110 {
    ...
    public static void main(String[] args) throws Exception {
        SqlSession sqlSession = new SqlSessionFactoryBuilder().build(Resources.getResourceAsStream(
                "com/osk2090/mybatis/ex02/e/mybatis-config.xml")).openSession();

        //결과 타입이 Map이면
        //selectList()의 리턴타입은 List<Map>이 된다
        ...
        컬럼 값을 꺼낼 때는 select 할 때 사용한 컬럼 이름으로 꺼내야 한다
         */
