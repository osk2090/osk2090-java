...
public class Exam0320 {
    public static void main(String[] args) throws Exception {
        ...
        그러나 파일에 저장된 Member 클래스의 serialVersionUID의 값이 다르다
